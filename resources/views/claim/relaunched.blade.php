                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customer.claim.save') }}" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" placeholder="Désignation" class="form-control " name="designation" value="{{$claim->designation}}" required autocomplete="designation" autofocus>
                        </div>


                        <div class="input-group mb-3">
                            <textarea name="description"  class="form-control"  id="description" cols="30" rows="10" placeholder="{{$claim->description}}"></textarea>
                        </div>
